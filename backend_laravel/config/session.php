...
return [
    ...
    'cookie' => env(
        'SESSION_COOKIE',
        Str::slug((string) env('APP_NAME', 'thakurbari'), '_').'_session'
    ),

    'path' => env('SESSION_PATH', '/'),
    'domain' => env('SESSION_DOMAIN'),

    // Must be true in production: the session cookie is HttpOnly + Secure so no
    // credential is ever readable from browser storage.
